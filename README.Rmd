...
The `KC-API-ENDPOINT` variable is optional. This is used to allow the user to use KuCoin's sandbox `api` for paper trading. If not set then the real `api` is used by default:
